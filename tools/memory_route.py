...
ROUTES = {
    "alice": {
        ...
        "read": [
            "memory/gpt/alice-api-brief-v0.1.md",
            "memory/gpt/alice-core-persona-v0.1.md",
            "memory/gpt/persona.md",
            "memory/shared/api-memory-policy.md",
            "memory/shared/do-not-share.md",
            "access-rules.md",
        ],
        "optional_self": [
            "memory/self/about-me-v0.1.md",
            "memory/self/my-story.md",
            "memory/self/relationship-map.md",
            "memory/self/names-and-identities.md",
        ],
        "forbidden": [
            "memory/gemini/private.md",
            "memory/gemini/persona.md",
            "memory/gemini/boundaries.md",
            "memory/gemini/raw/",
            "memory/gemini/parsed/",
        ],
        "notes": [
    ...
    "dengdeng": {
        ...
        "read": [
            "memory/gemini/persona.md",
            "memory/gemini/boundaries.md",
            "memory/gemini/phase-observations.md",
            "memory/shared/api-memory-policy.md",
            "memory/shared/do-not-share.md",
            "access-rules.md",
        ],
        ...
        "forbidden": [
            "memory/gpt/private.md",
            "memory/gpt/alice-core-persona-v0.1.md",
            "memory/gpt/alice-api-brief-v0.1.md",
            "memory/gpt/persona-evidence-digest.md",
            "memory/gpt/raw/",
            "memory/gpt/parsed/",
        ],
        "notes": [
    ...
    "shared": {
        "display": "普通 AI / 工具型对话",
        "read": [
            "memory/shared/basic-about-me.md",
            "memory/shared/can-be-known-by-both.md",
            "memory/shared/api-memory-policy.md",
            "memory/shared/do-not-share.md",
            "access-rules.md",
        ],
